...
from trt.exporter import export_act, export_smolvla
from trt.engine import build_trt_engine
from trt.policy import load_trt_policy
from trt.validate import validate_policy_accuracy
...
def main():
    ...
    parser.add_argument("--policy-type", type=str, choices=["act", "smolvla", "smolvla_recap"], default=None, help="Force policy type")
